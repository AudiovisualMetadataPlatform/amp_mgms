...
def main():
	...
	(input_video, amp_faces, contact_sheet, column, width, margin, padding) = (args.input_video, args.amp_faces, args.contact_sheet, args.column, args.width, args.margin, args.padding)
